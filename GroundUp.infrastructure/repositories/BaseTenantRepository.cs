...
{
    public class BaseTenantRepository<T, TDto> : BaseRepository<T, TDto>
        where T : class
        where TDto : class
    {
        ...
        // Multi-tenant versions of the internal pipelines, then defer to base class filtering/paging.
        ...
        public override async Task<ApiResponse<TDto>> AddAsync(TDto dto)
        {
